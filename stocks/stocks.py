...
def get_trade_data(trade_api, ticker_symbol):
    ...
    for i in range(3):
        try:
            ...
            return trade_api.polygon.historic_agg_v2(ticker_symbol, 1, 'day', _from=datetime.datetime.now() - datetime.timedelta(days=1265), to=datetime.datetime.now()).df
